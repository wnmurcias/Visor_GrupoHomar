...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 22, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:9377',
            extent: [4901680.508392, 2097735.658487, 4903694.813553, 2100735.925670],
            units: 'm'})
    })
});
...
map.getView().fit([4898105.081809, 2095784.794352, 4909563.790472, 2102370.658220], map.getSize());
